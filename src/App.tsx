    ...
    <div className="min-h-screen bg-[#FFF4EC] text-[#5A3A31] font-sans antialiased selection:bg-[#E94F7A] selection:text-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* ========================================================
           ...
           ======================================================== */}
        <section className="pt-8 pb-12 sm:pt-14 sm:pb-16 px-4 sm:px-6 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto text-center">

            {/* Post-Purchase Context Box */}
            <div className="bg-[#FFE3D3] border-2 border-[#E94F7A]/40 rounded-2xl p-4 sm:p-5 mb-8 shadow-sm text-left sm:text-center">
            ...
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black text-[#3A241C] leading-[1.15] mb-6 tracking-tight">
            ...
            <p className="text-base sm:text-xl text-[#5A3A31] font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            ...
            <div className="max-w-md mx-auto pt-2">
              <a
                href={CHECKOUT_URL}
                className="w-full py-4 px-6 rounded-2xl bg-[#E94F7A] hover:bg-[#D83D69] text-white font-black text-base sm:text-lg shadow-lg shadow-[#E94F7A]/25 transition-all inline-flex items-center justify-center gap-2 border border-[#F27598] no-underline cursor-pointer"
              >
                <span>SIM! QUERO ADICIONAR O AGENDA CHEIA POR R$37</span>
                <ArrowRight className="w-5 h-5 shrink-0" />
              </a>
              <div className="flex items-center justify-center gap-2 text-xs text-[#8A6A61] mt-2 font-medium">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-[#FFE3D3]/40 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#FFE3D3] border border-[#F3CFBE] rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <p className="text-base sm:text-lg font-medium text-[#3A241C] leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="bg-[#FFF4EC] border border-[#F0D5C7] rounded-2xl p-4 flex items-start gap-3">
                  <div className="w-7 h-7 rounded-xl bg-[#E94F7A]/15 text-[#E94F7A] flex items-center justify-center shrink-0 mt-0.5 font-bold">
                    ✕
                  </div>
                  <div>
                    <h3 className="text-sm font-black text-[#3A241C]">Posta no status e ninguém responde.</h3>
                    <p className="text-xs text-[#5A3A31] mt-0.5">As pessoas olham, passam reto e não pedem.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#FFF4EC] border border-[#F0D5C7] rounded-2xl p-4 flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-[#3A241C]">Vende uma vez e a cliente some.</h3>
                    <p className="text-xs text-[#5A3A31] mt-0.5">Sem um plano de recompra, cada venda vira um recomeço do zero.</p>
                  </div>
                </div>
              </div>

              {/* The heartbreaking truth callout */}
              <div className="bg-[#FFF4EC] border-2 border-[#E94F7A]/30 rounded-2xl p-5 space-y-3">
                <div className="flex items-center gap-2 text-xs font-black uppercase text-[#E94F7A]">
                  <AlertTriangle className="w-4 h-4 text-[#E94F7A]" />
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#3A241C] text-[#FFE3D3] rounded-3xl p-6 sm:p-10 shadow-xl relative overflow-hidden">
              <div className="relative z-10 space-y-6">
                ...
                <div className="bg-[#2C1B15] border border-[#4A2F25] rounded-2xl p-5 space-y-3">
                  <p className="text-sm sm:text-base text-[#FFE3D3] leading-relaxed">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-[#FFE3D3]/30 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-xl text-[#3A241C] font-extrabold max-w-2xl mx-auto leading-relaxed">
        ...
        {/* ========================================================
           ...
           ======================================================== */}
        <section className="py-12 sm:py-18 px-4 sm:px-6 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {EXACT_DELIVERABLES.map((item, index) => {
                ...
                return (
                  <div 
                    key={item.id}
                    className="bg-[#FFE3D3] border border-[#F3CFBE] rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-xs hover:border-[#E94F7A]/40 transition-colors"
                  >
                    <div className="flex items-start gap-4">
                      
                      {/* Check & Icon */}
                      <div className="w-10 h-10 rounded-2xl bg-[#FFF4EC] text-[#2FA866] flex items-center justify-center shrink-0 border border-[#F0D5C7] shadow-2xs mt-0.5">
                        <Check className="w-6 h-6 stroke-[3]" />
                      </div>

                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-1">
                          <h3 className="text-base sm:text-lg font-black text-[#3A241C]">
                        ...
                        <div className="mt-3 grid sm:grid-cols-2 gap-1.5 pt-2 border-t border-[#F0CFBE]">
                          {item.highlights.map((h, hIdx) => (
                            <div key={hIdx} className="flex items-center gap-1.5 text-xs text-[#3A241C] font-semibold">
                              <span className="text-[#2FA866] font-black text-xs">✓</span>
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-[#FFE3D3]/40 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#FFF4EC] border-2 border-[#E94F7A]/30 rounded-3xl p-6 sm:p-10 shadow-sm space-y-6">
              ...
              <div className="space-y-4 text-base sm:text-lg text-[#3A241C] leading-relaxed font-medium">
                <p>
                ...
                <div className="bg-[#FFE3D3] p-4 sm:p-5 rounded-2xl border border-[#F3CFBE]">
                  <p className="font-black text-[#3A241C] text-base sm:text-xl leading-snug">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 border-b border-[#F0D5C7]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#FFF4EC] border-2 border-[#2FA866] rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
              
              <div className="w-20 h-20 rounded-full bg-[#2FA866]/15 border-2 border-[#2FA866] text-[#2FA866] flex items-center justify-center shrink-0">
              ...
              <div className="space-y-2 flex-1">
                ...
                <p className="text-sm sm:text-base text-[#5A3A31] font-semibold leading-relaxed">
        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="bg-[#FFE3D3] border-3 border-[#E94F7A] rounded-3xl sm:rounded-[36px] p-6 sm:p-10 shadow-2xl relative overflow-hidden">
              
              {/* Badge */}
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#FFF4EC] text-[#E94F7A] text-xs font-black uppercase tracking-wider mb-4 border border-[#F0D5C7]">
              ...
              <p className="text-xs sm:text-sm font-black text-[#E94F7A] uppercase tracking-wide mb-6">
                Esta oferta aparece só agora, nesta página. Se você sair, ela não volta com esse valor.
              </p>

              {/* Price Callout */}
              <div className="bg-[#FFF4EC] border-2 border-[#E94F7A]/40 rounded-2xl p-5 mb-6 max-w-sm mx-auto shadow-sm">
                <span className="text-xs font-bold text-[#5A3A31] uppercase tracking-wider block mb-1">
                  Pagamento Único Promocional
                </span>
                <div className="text-3xl sm:text-4xl font-black text-[#3A241C]">
              ...
              <div className="space-y-3 text-sm sm:text-base text-[#3A241C] font-medium max-w-xl mx-auto mb-8 leading-relaxed text-left sm:text-center">
                <p>
                ...
                <p className="font-black text-base sm:text-lg text-[#E94F7A] bg-[#FFF4EC] p-3 rounded-xl border border-[#F0D5C7]">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-5 px-6 sm:px-8 rounded-2xl bg-[#E94F7A] hover:bg-[#D83D69] text-white font-black text-base sm:text-lg tracking-wide shadow-xl shadow-[#E94F7A]/35 transition-all cursor-pointer inline-flex items-center justify-center gap-3 border border-[#F27598] mb-4 no-underline"
              >
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-[#5A3A31] font-bold mb-6">
                <span className="flex items-center gap-1">
                  <ShieldCheck className="w-4 h-4 text-[#2FA866]" />
                  Garantia de 7 Dias
                </span>
                <span aria-hidden="true" className="text-[#F0CFBE]">·</span>
                <span className="flex items-center gap-1">
              ...
              <div className="pt-4 border-t border-[#F0CFBE]">
                <button
                  ...
                  className="text-xs sm:text-sm text-[#8A6A61] hover:text-[#3A241C] underline cursor-pointer transition-colors"
                >
      ...
      {/* Sticky Bottom Bar for Mobile & Scroll */}
      <StickyBottomBar />
      ...
      <footer className="bg-[#3A241C] text-[#FFE3D3] border-t border-[#2C1B15] py-8 px-4 text-center text-xs">
        <div className="max-w-3xl mx-auto space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-[#FFE3D3]/70 font-medium">
            <span>Garantia de 7 Dias</span>
            <span>·</span>
            <span>Acesso Imediato</span>
            <span>·</span>
